    ...
    public static class SeedData
    {
        public static void Initialize(IServiceProvider serviceProvider)
        {
            ...
            <DbContextOptions<ApplicationDbContext>>()))
            {
                ...
                new IdentityRole { Id = "2c5e174e-3b0e-446f-86af-483d56fd7211", Name = "Partener", NormalizedName = "Partener".ToUpper() },
                ...
                new ApplicationUser
                {
                    ...
                    UserName = "partener@test.com",
                    EmailConfirmed = true,
                    NormalizedEmail = "PARTENER@TEST.COM",
                    Email = "partener@test.com",
                    NormalizedUserName = "PARTENER@TEST.COM",
                    PasswordHash = hasher.HashPassword(null, "Partener1!")
                },
new ApplicationUser
{
